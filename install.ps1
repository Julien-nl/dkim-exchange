...
# Exchange 2013 SP1 CU23 (15.0.1497.2)
...
# Exchange 2016 CU11  (15.1.1591.01)
...
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 1 -and ($exchserver.admindisplayversion).build -eq 1713) {
	$EXVER="Exchange 2016 CU12"
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 1 -and ($exchserver.admindisplayversion).build -eq 1779) {
	$EXVER="Exchange 2016 CU13"
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 1 -and ($exchserver.admindisplayversion).build -eq 1847) {
	$EXVER="Exchange 2016 CU14"
...
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 2 -and ($exchserver.admindisplayversion).build -eq 464) {
	$EXVER="Exchange 2019 CU3
} else {
